...
Commentaire:
on obtient la moyenne imcenfant et la mediane imcenfant, alors la difference est la moyenne moins la mediane
...
IMC.zep0 <- imcenfant$IMC[imcenfant$zep=="O"]
summary(IMC.zep0)
```

Commentaire: Cela correspond aux enfants de l'échantillon qui sont  dans une ecole située en zone d'éducation prioritaire 
...
```
 ...
 Commentaire: Cela correspond aux enfants de l'échantillon qui ne sont pas située dans une zone d'éducation prioritaire.
